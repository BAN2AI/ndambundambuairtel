...
class CategoryPage extends StatefulWidget {
  ...
  final int id;
  const CategoryPage({Key key, this.categorie, this.id}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: new AppBar(
          ...
          title: Text(widget.categorie, style: TextStyle(color: Colors.white)),
          backgroundColor: LightColor.orange,
          shadowColor: Colors.white.withOpacity(0),
        ),
        body: FutureBuilder(
            future: Provider().getProductsByCategorie(widget.id.toString()),
