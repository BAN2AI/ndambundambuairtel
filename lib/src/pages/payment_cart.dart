...
class PayementCart extends StatefulWidget {
  final dynamic order;
  final List<dynamic> product;

  const PayementCart({Key key, this.order, this.product}) : super(key: key);
  @override
  _PayementCartState createState() => _PayementCartState();
}

class _PayementCartState extends State<PayementCart> {
  @override
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Center(
            child: Text(
              "Produits : " + widget.product.length.toString(),
  ...
  Widget buildUpgradeButton() => DefaultButton(
        ...
        press: () {
          ...
          Provider()
              .placeCommandeAll(widget.order, widget.product)
              .then((value) => {
                    Navigator.of(context).pop(),
                    print(value),
                    Provider().removePanier(),
  ...
  showSuccessAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Votre payement est effectuer"),
      actions: [
        okButton,
      ],
    );
