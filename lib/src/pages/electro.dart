...
class ElectroPage extends StatefulWidget {
  ElectroPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ElectroPageState createState() => _ElectroPageState();
}

class _ElectroPageState extends State<ElectroPage> {
        ...
        children: AppData.categoryListHome
            .map(
              (category) => ProductIcon(
                ...
                onSelected: (model) {
                  setState(() {
                    AppData.categoryListHome.forEach((item) {
  ...
  Widget _productWidget() {
    return Container(
      ...
      child: GridView(
        ...
        scrollDirection: Axis.horizontal,
        children: AppData.productListElectro
            .map(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: FutureBuilder(
                  future: Provider().getProductsByCategorie("7"),
