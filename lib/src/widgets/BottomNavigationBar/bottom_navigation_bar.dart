        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                _icon(Icons.airplane_ticket, _selectedIndex == 0, 0),
                _icon(Icons.tv_outlined, _selectedIndex == 1, 1),
                _icon(Icons.house, _selectedIndex == 2, 2),
                _icon(CupertinoIcons.bag_badge_plus, _selectedIndex == 3, 3),
              ],
            ),
          ),
        ],
